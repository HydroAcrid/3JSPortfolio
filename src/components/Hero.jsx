...
//             I'm a Full Stack Devloper in my third year of University. I love to build things that live on the internet.
//           </p>
//         </div>
//       </div> 
//       <ComputersCanvas />
    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm a Full Stack Devloper in my third year of University. 
            <br className='sm:block hidden' />
            I love to build things that live on the internet.
          </p>
        </div>
      </div>
